...
family_items_to_create = [test_items.get_andersen_family_item(), test_items.get_johnson_family_item(), test_items.get_smith_family_item(), test_items.get_wakefield_family_item()]
